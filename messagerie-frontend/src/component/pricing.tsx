...
export default function PricingSection() {
    return (
        <section className="py-4 px-2 bg-white">
            <h2 className="text-4xl font-bold text-center mb-3">Nos offres</h2>
            <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Free Plan */}
                <div className="border rounded-xl p-8 shadow-sm hover:shadow-md transition">
                    <h3 className="text-2xl font-semibold mb-2">Free</h3>
                    <p className="text-gray-500 mb-3">Parfait pour commencer</p>
                    ...
                    <p className="mt-3 text-2xl font-bold">Gratuit</p>
                </div>
                ...
                <div className="border-2 border-blue-600 rounded-xl p-8 shadow-lg bg-blue-50">
                    ...
                    <p className="text-blue-600 mb-3">Pour les utilisateurs exigeants</p>
                    ...
                    <p className="mt-3 text-2xl font-bold text-blue-700">9,99 €/mois</p>

                    <Link
                        href="/sign-up"
                        className="mt-4 inline-block bg-blue-600 text-white px-3 py-2 rounded-full hover:bg-blue-700 transition"
                    >
